...
module.exports = eval("require")("json-diff");
...
module.exports = eval("require")("jsonlint");
...
async function run() {
  try {
    ...
    const newman = __nccwpck_require__(35);
    const jsonlint = __nccwpck_require__(875);
    const jsonDiff = __nccwpck_require__(346);
